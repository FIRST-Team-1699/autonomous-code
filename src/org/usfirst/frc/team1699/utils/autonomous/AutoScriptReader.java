...
public class AutoScriptReader {
	 ...
	 * @return
	 */
	public List<String> getFileAsString() { // Returns the ArrayList of the file
											// as a string
		return fileAsString;
	}
	...
	public void runScript() {
		for (int i = 0; i < fileAsString.size(); i++) { // Loops through
														// fileAsString array
			try {
			...
			} catch (CommandNotFoundException e) { // Detects if there is a
													// error where the command
													// is not found
